...
/* harmony import */ var _modules_search__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/search */ "./js/modules/search.js");
...
var initSearch = function initSearch() {
  return new _modules_search__WEBPACK_IMPORTED_MODULE_15__["Search"]();
};
...
var Search = /*#__PURE__*/function () {
  ...
  _createClass(Search, [{
    ...
    key: "_onSearchInputInput",
    value: function _onSearchInputInput(event) {
      this._displayMatches(event);
    }
  }, {
    key: "_findMatches",
    value: function _findMatches(wordToMatch, elements) {
      return elements.filter(function (place) {
    ...
    key: "_displayMatches",
    value: function _displayMatches(_ref2) {
      var _this = this;
      var target = _ref2.target;
      this._value = target.value;
      var matchArray = this._findMatches(this._value, this._elementsArr);
      var html = matchArray.map(function (element) {
        var regex = new RegExp(_this._value, 'gi');
        var resultTitle = element.title.replace(regex, "<span class=\"search__hl\">".concat(_this._value, "</span>"));
        var resultTag = element.tag.replace(regex, "<span class=\"search__hl\">".concat(_this._value, "</span>"));
        return "\n        <li class=\"search__item\">\n            <a class=\"search__link\" href=\"".concat(element.link, "\">\n                <span class=\"search__text\">").concat(resultTitle, "</span>\n                <span class=\"search__text\">").concat(resultTag, "</span>\n            </a>\n        <li>\n      ");
      }).join('');
    ...
    value: function _onSuccess(data) {
      var _this$_elementsArr;
      (_this$_elementsArr = this._elementsArr).push.apply(_this$_elementsArr, _toConsumableArray(data));
    ...
    value: function _getData() {
      Object(_utils_api__WEBPACK_IMPORTED_MODULE_0__["getData"])(this._url, this._onSuccess, this._onFail);
    }
  }, {
    key: "_init",
...
var getData = function getData(url, onSuccess, onFail) {
...
var sendData = function sendData(url, onSuccess, onFail, body) {
  fetch(url, {
    method: 'POST',
    body: body
