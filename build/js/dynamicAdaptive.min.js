...
var DynamicAdaptive = /*#__PURE__*/function () {
  ...
  _createClass(DynamicAdaptive, [{
    ...
    value: function init() {
      ...
      this._mediaQueries = this._objects.map(function (item) {
      ...
      this._mediaQueries.forEach(function (media) {
        ...
        var objectsFilter = _this._objects.filter(function (item) {
...
var initDynamicAdaptive = function initDynamicAdaptive() {
  var da = new _dynamic_adaptive__WEBPACK_IMPORTED_MODULE_0__["DynamicAdaptive"]('max');
  da.init();
};
