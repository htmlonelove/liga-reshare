...
/* harmony import */ var _modules_init_search_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./modules/init-search.js */ "./js/modules/init-search.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_search_js__WEBPACK_IMPORTED_MODULE_15__["initSearch"])();
  });
});
...
var initSearch = function initSearch() {
  ...
  var searchNote = document.querySelector('.search__note');
  var pathData = '../data/dataSearch.json';
  var elementsArr = [];
  ...
  function displayMatches() {
    var _this = this;
    var matchArray = findMatches(this.value, elementsArr);
    var html = matchArray.map(function (element) {
      var regex = new RegExp(_this.value, 'gi');
      var resultTitle = element.title.replace(regex, "<span class=\"search__hl\">".concat(_this.value, "</span>"));
      var resultTag = element.tag.replace(regex, "<span class=\"search__hl\">".concat(_this.value, "</span>"));
  ...
  var getFetchData = function getFetchData(path) {
    return fetch(path).then(function (res) {
      return res.json();
    }).then(function (data) {
      elementsArr.push.apply(elementsArr, _toConsumableArray(data));
    });
  };
