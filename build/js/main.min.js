...
var initArticleMenu = function initArticleMenu() {
  ...
  document.addEventListener('click', function (e) {
    var target = e.target; // Toggle по кнопке
  ...
  if (breakpointMd.matches) {
    if (headerPosition >= contentWrapperPosition) {
      ...
      if (footerHeightVisible >= 0) {
        ...
        navbar.style.bottom = "".concat(footerHeightVisible, "px"); // navbar.style.transform = `translate3d(0, -${footerHeightVisible}px, 0)`;
      } else {
        navbar.style.bottom = '0'; // navbar.style.transform = 'translate3d(0, 0, 0)';
      }
    } else {
  ...
  var headerObserver = new ResizeObserver(function (entries) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        var headerHeight = entry.borderBoxSize[0].blockSize;
        main.style.paddingTop = "".concat(headerHeight, "px"); // if (navbar) {
        //   if (breakpointMd.matches) {
...
var initTabs = function initTabs() {
  tabs = new _utils_tabs__WEBPACK_IMPORTED_MODULE_0__["Tabs"](); // Используйте в разработке экспортируемую переменную tabs, window сделан для бэкэнда
